                ...
                {
                  $('#img_class').append('<article class="article" id="myimg"> <div class="card"><div class="card-pic-wrap"><img src="https://images-na.ssl-images-amazon.com/images/I/71iXsMKTvtL.png" alt="A leafy plant"></div><div class="card-content"><h3>A leafy one</h3><p>Blossom dorset heath scabious ipsum. Grape hyacinth bee balm bird of paradise obedient plant african lily lily. Spring foxglove florist’s nighmare primrose.</p><p><a href="#0">So leafy</a></p></div></div></article>');
